...
#include "wavefront_online.h"

#define MAP "complete_map_project.pgm"
...
onlineWaveFront::onlineWaveFront(void){
...
void onlineWaveFront::makeWaveFront(int robotPOSX,int robotPOSY, int goalPOSX,int goalPOSY){
	...
	img.loadImage(MAP);	// Reset to the next wavefront
	...
	coordinate* wavebuffer = new coordinate[796500];
	coordinate* wavebuffer2 = new coordinate[796500];
...
/*
int main() {
	onlineWaveFront wFront;
	wFront.makeWaveFront(700,100,900,900); // From (700,100) to (900,900)
}
*/
